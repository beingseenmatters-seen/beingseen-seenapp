...
function getRandomCopy(options) {
  return options[Math.floor(Math.random() * options.length)];
}

function calculateArrayJaccard(arr1, arr2) {
...
export function generatePrimaryMatchReason(currentUser, candidateUser) {
